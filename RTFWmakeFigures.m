function forms = RTFWmakeFigures(fileName)
    ...
    forms{4}.cloneAxesIn(axesArray(24),5);
    forms{4}.cloneAxesIn(axesArray(22),6);
    forms{4}.cloneAxesIn(axesArray(23),7);
    forms{4}.cloneAxesIn(axesArray(20),8);
    forms{4}.cloneAxesIn(axesArray(25:33),9:17);
